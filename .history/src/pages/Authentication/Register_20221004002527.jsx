...
import { Row, Col, CardBody, Card, Alert, Container, Spinner, Button, NavItem, NavLink, TabContent, TabPane } from "reactstrap";
    ...
    <React.Fragment>
      ...
      <Row>
        ...
        <Col md={9}>
          ...
          <div className="form-horizontal form-wizard-wrapper wizard clearfix mt-3">
