                      ...
                      <AvForm className="mt-4" onValidSubmit={(e, v) => { handleValidSubmit(e, v) }}>
                        ...
                        <div className="mb-3 row mt-3">
                          <div className="col-12 text-start">
                            <button className="btn login-btn w-100 waves-effect waves-light" type="submit">
                              {
                                !btnLoading ? <span className="me-2">Submit</span> : null
                              }
                              {
                                !btnLoading ? null : <span>  <Spinner as="span" animation="border" size="sm" /> Loading...</span>
                              }
                            </button>
                          </div>
                        </div>
