...
import { Row, Col, Badge, Card, Modal, Button, Spinner, OverlayScrollbarsComponent } from 'react-bootstrap';
                                ...
                                <table className="table align-middle table-nowrap mb-0">
                                    ...
                                    <tbody>
                                        ...
                                        <tr key={"_tr_" + "key"} >
                                            ...
                                            <td>{"john"} {"muleka"}</td>
                                            <td>{"email"}</td>
                                            <td> <Badge bg="outline-primary"> { } </Badge> </td>
                                            <td>{'gfg'}</td>
                                            ...
                                            <td>
                                                <Link to={`/`}>
                                                    <Badge className="cursor-pointer bg-info">
                                                        {/* <CsLineIcons icon="dollar" size="14" />  */}
                                                        Pay Now
                                                    </Badge>
                                                </Link>
                                            </td>
