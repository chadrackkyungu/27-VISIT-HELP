...
const Employees = () => {
    ...
    const { data, length, error, reFetch } = useFetch(`https://tourisms.herokuapp.com/api/v1/users`, token);
    ...
    if (data.length <= 0) { return <Layout>  <Empty empty="You have no lead guide yet" /> </Layout> }
    ...
    return (
        <Layout>
            ...
            <Modal show={AddLeadGuide} onHide={() => setAddLeadGuide(false)} size="lg">
                ...
                <Modal.Body>
                    <Form closeModal={setAddLeadGuide} reFetch={reFetch} />
                </Modal.Body>
            ...
            <Modal show={lExample} onHide={() => setLExample(false)} size="lg">
                ...
                <Modal.Body>
                    <LeadGuideDetails id={leadGuide} leadGuides={filterLeadGuide} closeModal={setAddLeadGuide} reFetch={reFetch} />
                </Modal.Body>
