...
const Employees = () => {
    ...
    const { data, reFetch } = useFetch(`https://tourism.up.railway.app/api/v1/users`, token);
    ...
    const deleteFunc = () => {
        ...
        fetch(`https://tourism.up.railway.app/api/v1/users/${leadGuide}`, requestOptions)
                            ...
                            <table className="table align-middle table-nowrap mb-0">
                                <thead className="table-light">
                                    <tr>
                                        ...
                                        <th className="align-middle">Lead Guide ID</th>
