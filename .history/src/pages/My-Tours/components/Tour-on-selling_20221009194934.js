                    ...
                    <Card className='tour-card'>
                        <CardBody>
                            ...
                            <div className="d-flex justify-content-between align-items-center mt-3">
                                <Badge className='p-2 text-white'>  <Link to="/tour-details/1" className='text-white'>  open </Link> </Badge>
                                <Badge className='p-2 bg-warning'> close </Badge>
                                <Badge className='p-2 bg-danger'> Move to progress </Badge>
                            </div>
                        </CardBody>
                    </Card>
                </Col>
