                            ...
                            <Row>
                                ...
                                <Col md={3}>
                                    <div className="d-flex justify-content-center align-items-center mt-3">
                                        ...
                                        <input type="file" ref={refFileUpload} className="file-upload d-none" accept="image/*" onChange={changeThumb2} />
                                    </div>
                                </Col>
                                ...
                                <Col md={3}>
                                    <div className="d-flex justify-content-center align-items-center mt-3">
                                        ...
                                        <input type="file" ref={refFileUpload} className="file-upload d-none" accept="image/*" onChange={changeThumb3} />
                                    </div>
                                </Col>
                                ...
                                <Col md={3}>
                                    <div className="d-flex justify-content-center align-items-center mt-3">
                                        ...
                                        <input type="file" ref={refFileUpload} className="file-upload d-none" accept="image/*" onChange={changeThumb4} />
                                    </div>
                                </Col>
