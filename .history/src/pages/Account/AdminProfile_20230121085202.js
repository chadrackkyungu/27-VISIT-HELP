...
const AdminProfile = () => {
    ...
    function handleValidSubmit(e, values) {
        ...
        fetch("https://tourism.up.railway.app/api/v1/users/updateMe", requestOptions)
    ...
    function handleValidSubmit2(e, values) {
        ...
        fetch("https://tourism.up.railway.app/api/v1/users/updateMyPassword", requestOptions)
            .then(response => response.json())
            .then(result => {
                if (result.status === 'success') {
                    dispatch(Login(""));
